...
const envVarsSchema = Joi.object()
  .keys({
    ...
    AUTO_START_CRON: Joi.boolean().required().description('Start cron jobs automatically, on app boot'),
...
if (error) {
  throw new Error(`Config data is not valid: ${error.message}, Please review '.env' file.`);
}
...
module.exports = {
  ...
  // },
  start_cron: envVars.AUTO_START_CRON,
  force_json_response: appSettings.force_json_response,
